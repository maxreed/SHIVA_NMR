...
for ss_type in ["C","E","H"]:
    DATA_DIR_test = "feats_SS_ensemble_" + ss_type
    ...
    model_name = "weights/xgb_n_SSensemble_it2_2x_est600_dep7_purge_isolated_" + ss_type + ".pkl"
    ...
    }).to_csv("test_predictions_n_" + ss_type + ".csv", index=False)

    print(ss_type + " prediction complete!")
